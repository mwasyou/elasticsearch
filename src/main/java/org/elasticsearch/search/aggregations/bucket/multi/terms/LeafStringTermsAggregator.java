 ...
 */
public class LeafStringTermsAggregator extends Aggregator {
    ...
    public LeafStringTermsAggregator(String name, AggregatorFactories factories, ValuesSource valuesSource,
        ...
        assert factories.perBucketCount() == 0;
        subAggregators = factories.createMultiBucketAggregators(this, 50); // TODO sizing
    }
